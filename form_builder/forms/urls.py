...
urlpatterns = [
    ...
    path('view/<str:pk>/',FormResponseSubmitAPI.as_view(),name='form-view'),
    path('view_response/', FormResponseDetail.as_view(), name='view-response'),
    path('responses/', FormResponseByForm.as_view(), name='form-response'),
